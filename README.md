...
- [ ] Explain what a token is used for.  -Authentication If not provided server will deny requests
- [ ] What steps can you take in your web apps to keep your data secure?, encryption, reuire strong passwords, authentication and authorization
- [ ] Describe how web servers work. they connect trough diffrent networks mainly internet, and make requests (clients) amd get responses
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers. CREATE - READ - UPDATE - DELETE
